...
jQuery(function() {
    jQuery(".wpjb-location-state").wpjb_suggest(Wpjb.Ajax, {
        onSearch: function(q) {
            q.action = "wpjb_suggest_state";
            q.country = 0;
            
            if(jQuery(".wpjb-location-country").length == 1) {
                q.country = jQuery(".wpjb-location-country").val();
            }
            
            return q;
        }
    });
    jQuery(".wpjb-location-city").wpjb_suggest(Wpjb.Ajax, {
        onSearch: function(q) {
            ...
            if(jQuery(".wpjb-location-state").length == 1) {
                q.state = jQuery(".wpjb-location-state").val();
            }
