<?php $this->slot("title", __("Job Types List", WPJB_DOMAIN)); ?>
<?php $this->_include("header.php"); ?>

<div class="wpjb-buttons">
    <a href="<?php echo $this->_url->linkTo("wpjb/jobType", "edit"); ?>"class="button button-highlighted">
        <?php _e("Add New Job Type", WPJB_DOMAIN) ?>
    </a>
</div>
...
<script type="text/javascript">
    Wpjb.DeleteType = "<?php _e("job type", WPJB_DOMAIN) ?>";
</script>
...
<table cellspacing="0" class="widefat post fixed">
	...
	<tr valign="top" class="<?php if($i%2==0): ?>alternate <?php endif; ?>  author-self status-publish iedit">
            ...
            <td class="post-title column-title">
                <strong><a title='<?php _e("Edit", WPJB_DOMAIN) ?>  "(<?php echo esc_html($item->title) ?>)"' href="<?php echo $this->_url->linkTo("wpjb/jobType", "edit/id/".$item->getId()); ?>" class="row-title"><?php echo esc_html($item->title) ?></a></strong>
                <div class="row-actions">
                    <span class="edit"><a title="<?php _e("Edit", WPJB_DOMAIN) ?>" href="<?php echo $this->_url->linkTo("wpjb/jobType", "edit/id/".$item->getId()); ?>"><?php _e("Edit", WPJB_DOMAIN) ?></a> | </span>
                    <span class=""><a href="#<?php echo $item->getId() ?>" title="<?php _e("Delete", WPJB_DOMAIN) ?>" class="wpjb-delete"><?php _e("Delete", WPJB_DOMAIN) ?></a> | </span>
                    <span class="view"><a rel="permalink" title="<?php _e("View", WPJB_DOMAIN) ?>" href="<?php echo Wpjb_Project::getInstance()->getUrl()."/".Wpjb_Project::getInstance()->router("frontend")->linkTo("jobtype", $item) ?>"><?php _e("View", WPJB_DOMAIN) ?></a></span>
                </div>
            </td>
...
<div class="tablenav">
    <div class="tablenav-pages">
        ...
        echo paginate_links( array(
                'base' => $this->_url->linkTo("wpjb/jobType", "index/page/%_%"),
                'format' => '%#%',
                'prev_text' => __('&laquo;'),
                'next_text' => __('&raquo;'),
                'total' => $total,
