<div class="updated fade below-h2">
    <small><strong><?php _e("Make sure to enable \"Anyone can register\" option in <a href=\"options-general.php\">WP settings</a> if you wish to allow employer/employee registration.", WPJB_DOMAIN) ?></strong></small>
</div>
