...
if ($user_ID != null)
{
	...
	<section id="primary" class="content-area">
		<main id="main" class="site-main" role="main" style="overflow: scroll;">   
			<h1>公司估值历史数据</h1>
                    ...
                    <table style="width:100%; ">  
                        ...
                        <tbody id="mybody"> 
                            <?php
                            //这里是PHP代码
                            if( $result ) {foreach ($result as $k => $v) //循环开始
                            {
                                ?>  
                                ...
                                <tr>
                                    ...
                                    <td><input class="tblinput" type="text" required name="company_name_<?php echo $v->id; ?>" id="company_name_<?php echo $v->id; ?>" value="<?php echo $v->company_name; ?>"/></td>
                                    ...
                                    <td><input class="tblinput" type="text" required name="valuation_date_<?php echo $v->id; ?>" id="valuation_date_<?php echo $v->id; ?>" value="<?php echo $v->valuation_date; ?>" /></td>
                                    ...
                                    <td><input class="tblinput" type="text" required name="oonline_date_<?php echo $v->id; ?>" id="oonline_date_<?php echo $v->id; ?>" value="<?php echo $v->oonline_date; ?>" /></td>
			...
			<?
				...
				$total = $wpdb->get_var( "SELECT COUNT(`id`) FROM {$wpdb->prefix}company_valuation" );
